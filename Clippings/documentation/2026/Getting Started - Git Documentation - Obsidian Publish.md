...
You can either start by cloning an existing remote repository as described [here](https://publish.obsidian.md/git-doc/Getting+Started#For%20existing%20remote%20repository) or start with initializing a new repository locally and optionally push that to a remote repository as described [here](https://publish.obsidian.md/git-doc/Getting+Started#Create%20new%20local%20repository).

## Create new local repository

1. Follow the [Installation](https://publish.obsidian.md/git-doc/Installation) instructions for your operating system
...
4. If you want to Setup to push it to a remote repository like to GitHub:
	1. Setup [Authentication](https://publish.obsidian.md/git-doc/Authentication)
		2. Ensure that the remote repository is empty. Otherwise delete the repository and instead proceed to clone the remote repository as described in the [next section](https://publish.obsidian.md/git-doc/Getting+Started#For%20existing%20remote%20repository).
...
To clone, you have to use a remote URL. This can be one of two protocols: either `https` or `ssh`. This depends on your chosen [Authentication](https://publish.obsidian.md/git-doc/Authentication) method.  
`https`: `https://github.com/<username>/<repo>.git`  
`ssh`: `git@github.com:<username>/<repo>.git`

1. Follow the [Installation](https://publish.obsidian.md/git-doc/Installation) instructions for your operating system
2. Setup [Authentication](https://publish.obsidian.md/git-doc/Authentication)
...
4. Read on how to best configure your [.gitignore](https://publish.obsidian.md/git-doc/Tips-and-Tricks#Gitignore)
...
Similar steps as [existing repo](https://publish.obsidian.md/git-doc/Getting+Started#existing-repo), except use the `Initialize a new repo` command, followed by `Edit remotes` to add the remote repo to track. This remote repo will need to exist and be empty. Also make sure to read on how to best configure your [.gitignore](https://publish.obsidian.md/git-doc/Tips-and-Tricks#Gitignore).