...
source: "https://docs.paperclip.ing/#/guides/projects-workflow/workspaces"
author:
published:
created: 2026-05-13
description:
...
![Execution workspace list showing multiple isolated workspaces for a project](https://docs.paperclip.ing/user-guides/screenshots/dark/org/execution-workspaces-list.png)
...
![Workspace list](https://docs.paperclip.ing/user-guides/screenshots/dark/workspaces/list.png)
...
![Configuration tab](https://docs.paperclip.ing/user-guides/screenshots/dark/workspaces/configuration.png)
...
![Runtime logs tab](https://docs.paperclip.ing/user-guides/screenshots/dark/workspaces/runtime-logs.png)
...
![Issues tab](https://docs.paperclip.ing/user-guides/screenshots/dark/workspaces/issues.png)
...
[Heartbeats & Routines →](https://docs.paperclip.ing/routines.md)