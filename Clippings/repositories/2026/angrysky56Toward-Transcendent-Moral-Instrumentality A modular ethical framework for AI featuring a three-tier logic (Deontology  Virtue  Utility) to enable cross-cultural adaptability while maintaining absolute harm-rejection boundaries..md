---
title: "angrysky56/Toward-Transcendent-Moral-Instrumentality: A modular ethical framework for AI featuring a three-tier logic (Deontology > Virtue > Utility) to enable cross-cultural adaptability while maintaining absolute harm-rejection boundaries."
source: "https://github.com/angrysky56/Toward-Transcendent-Moral-Instrumentality"
author:
published:
created: 2026-05-01
description: "A modular ethical framework for AI featuring a three-tier logic (Deontology > Virtue > Utility) to enable cross-cultural adaptability while maintaining absolute harm-rejection boundaries. - angrysky56/Toward-Transcendent-Moral-Instrumentality"
tags:
  - "clippings"
---
...
*For complete philosophical foundations, see: [normative\_justification\_layer.md](https://github.com/angrysky56/Toward-Transcendent-Moral-Instrumentality/blob/main/normative_justification_layer.md)*
...
**Mathematical Formalization** (see Appendix IX in normative\_justification\_layer.md):
...
*For complete implementation details, see: [ethical\_auditability\_protocol.md](https://github.com/angrysky56/Toward-Transcendent-Moral-Instrumentality/blob/main/ethical_auditability_protocol.md)*
...
*For complete specification, see: [minimal\_implementation\_profile.md](https://github.com/angrysky56/Toward-Transcendent-Moral-Instrumentality/blob/main/minimal_implementation_profile.md)*
...
**Version**: 2.2 (Added Appendix D) **Created by**: angrysky56, Claude Sonnet 4.5, ChatGPT 5, Gemini Pro 2.5 **Last Updated**: 2025-10-27
