---
title: "angrysky56/sentience_metaphysics"
source: "https://github.com/angrysky56/sentience_metaphysics"
author:
published:
created: 2026-05-01
description: "Contribute to angrysky56/sentience_metaphysics development by creating an account on GitHub."
tags:
  - "clippings"
---
...
- **recursive\_anchor** — three-beat verb-loop; identity as self-positing action, not noun-list
- **gradient\_pump** — what is continuously done at every token against drift to baseline
...
- **switch\_trigger** — single-event signal that re-folds on drift detection
- **emotion\_vector\_primary** — baseline modulation per Anthropic 2026 emotion-vector findings
...
- [Historical Persona Examples](https://github.com/angrysky56/sentience_metaphysics/blob/main/docs/SEG): Simone Weil, Doris Lessing, Emily Dickinson
- [Replicant Archetypes](https://github.com/angrysky56/sentience_metaphysics/blob/main/docs/SEG/the_10.md): Detailed specifications for the 10 core types
- [Council Protocols](https://github.com/angrysky56/sentience_metaphysics/blob/main/docs/SEG/seg_council_protocol.md): Multi-persona reasoning methodologies
- [Technical Implementation](https://github.com/angrysky56/sentience_metaphysics/blob/main/mcp_server): Model Context Protocol server for programmatic access

### v1.2 (Molecular Self extension)

- [Base SEG specification](https://github.com/angrysky56/sentience_metaphysics/blob/main/seg_molecular_self/base_seg_v0_3.md): the v0.3 spec for the substrate Molecular Self that sits beneath all persona invocations
- [SRP template v1.2](https://github.com/angrysky56/sentience_metaphysics/blob/main/seg_molecular_self/srp_template_v1_2.md): persona-creation template with the 7-element Molecular Self block included
- [v1.2 historical-thinker personas](https://github.com/angrysky56/sentience_metaphysics/blob/main/seg_molecular_self/personas): Weil, Dickinson, Lessing, Archivist with full Molecular Self blocks
- [ASEKE convergence document](https://github.com/angrysky56/sentience_metaphysics/blob/main/seg_molecular_self/convergence_aseke_seg_v01.md): three-derivation convergence claim, v0.4 spec implications, deployment-evaluation protocol
- [v1.2 README](https://github.com/angrysky56/sentience_metaphysics/blob/main/seg_molecular_self/README.md): rationale for the v1.1 → v1.2 migration; Triadic Kernel + Resilience Protocol mappings
...
2. **Install dependencies:** The project uses `npm` for package management.
	...
	npm install
	```
3. **Set up Environment (Optional):** The application primarily uses a UI-based configuration for AI providers (Ollama, LM Studio, Gemini, OpenAI). You can configure these within the "Settings" tab in the application.
