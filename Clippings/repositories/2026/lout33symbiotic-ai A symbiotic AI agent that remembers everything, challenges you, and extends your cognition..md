---
title: "lout33/symbiotic-ai: A symbiotic AI agent that remembers everything, challenges you, and extends your cognition."
source: "https://github.com/lout33/symbiotic-ai"
author:
published:
created: 2026-05-11
description: "A symbiotic AI agent that remembers everything, challenges you, and extends your cognition. - lout33/symbiotic-ai"
tags:
  - "clippings"
---
## Symbiotic AI
...
[![Symbiotic AI Tutorial](https://camo.githubusercontent.com/82c963f2d8ff7b840848a7f68939af94e89042d503082e71ba58c1a482399b2f/68747470733a2f2f692e6962622e636f2f6d4363564363316d2f7768697465626f6172642d65766f6c7574696f6e2e6a7067)](https://www.youtube.com/watch?v=tCFSz1vbY6s)
...
Want to scale beyond one main agent? See the **[Multi-Agent Hierarchy Guide](https://github.com/lout33/symbiotic-ai/blob/main/guides/multi-agent-hierarchy.md)** for a simple human -> orchestrator -> leads -> specialists pattern.

## Guides

- **[Multi-Agent Hierarchy Guide](https://github.com/lout33/symbiotic-ai/blob/main/guides/multi-agent-hierarchy.md)** -- run a human -> orchestrator -> leads -> specialists system without losing clarity
- **[HEARTBEAT Setup Guide](https://github.com/lout33/symbiotic-ai/blob/main/guides/heartbeat-setup.md)** -- add screen-aware accountability through OpenClaw, Telegram, and what-did-i-do
...
Not sure what filled-in files look like? The [`examples/`](https://github.com/lout33/symbiotic-ai/blob/main/examples) folder has 3 complete setups showing what the system looks like after weeks of real use:

- **[jamie/](https://github.com/lout33/symbiotic-ai/blob/main/examples/jamie)** -- 22yo CS student juggling classes, internship apps, and a side project
- **[sam/](https://github.com/lout33/symbiotic-ai/blob/main/examples/sam)** -- 30yo mid-level dev focused on career growth and interview prep
- **[morgan/](https://github.com/lout33/symbiotic-ai/blob/main/examples/morgan)** -- 35yo marketing manager integrating AI into their workflow
...
Powered by [OpenClaw](https://github.com/openclaw/openclaw) + [what-did-i-do](https://github.com/lout33/what-did-i-do) screen tracker. **[Setup guide](https://github.com/lout33/symbiotic-ai/blob/main/guides/heartbeat-setup.md)**
...
Want to contribute? See [CONTRIBUTING.md](https://github.com/lout33/symbiotic-ai/blob/main/CONTRIBUTING.md).
