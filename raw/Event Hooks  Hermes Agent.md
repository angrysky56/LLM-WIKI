...
| **[Plugin hooks](#plugin-hooks)** | `ctx.register_hook()` in a [plugin](https://hermes-agent.nousresearch.com/docs/user-guide/features/plugins) | CLI + Gateway | Tool interception, metrics, guardrails |
