...
source: "https://docs.paperclip.ing/#/reference/adapters/hermes-local"
author:
published:
created: 2026-05-12
description:
...
- The runtime lives behind a webhook or API. Use [OpenClaw Gateway](https://docs.paperclip.ing/openclaw-gateway.md) or [HTTP](https://docs.paperclip.ing/http.md).
- You only need a one-shot shell command. Use [Process](https://docs.paperclip.ing/process.md).
