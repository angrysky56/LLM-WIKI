...
summary: "Open-source Next.js web app — AI outpainting (Gemini via OpenRouter) with Poisson-blended seams, plus 4 game-art studios (Parallax, Tiles, Sprites, Props). Five workspaces in one app; BYOK localStorage proxy."
tags: [image-extender, tools, image, ai, open-source, game-art, gemini, outpainting, nextjs]
sources: [https://github.com/boona13/image-extender]
status: reference
confidence: 0.85
---
