...
Preview: ## LLM Wiki  A pattern for building personal knowledge bases using LLMs.  This is an idea file, it is designed to be copy pasted to your own LLM Agent (e.g. OpenAI Codex, Claude Code, OpenCode / Pi, o...

## [2026-04-07 20:00] write

Updated page: wiki/sources/llm-wiki-pattern.md

## [2026-04-07 20:01] write

Updated page: wiki/concepts/persistent-knowledge-compilation.md

## [2026-04-07 20:01] write

Updated page: wiki/concepts/rag.md

## [2026-04-07 20:01] write

Updated page: wiki/entities/andrej-karpathy.md

## [2026-04-07 20:01] write

Updated page: wiki/entities/project-synapse.md

## [2026-04-07 20:03] index

Index updated with 6 pages

## [2026-04-07 20:04] lint

🩺 **Wiki Health Check** — 7 pages

**Broken links** (18):
  - wiki/concepts/persistent-knowledge-compilation.md → [[RAG]]
  - wiki/concepts/persistent-knowledge-compilation.md → [[Memex]]
  - wiki/concepts/persistent-knowledge-compilation.md → [[LLM Wiki Pattern]]
  - wiki/concepts/persistent-knowledge-compilation.md → [[Project Synapse]]
  - wiki/concepts/rag.md → [[Persistent Knowledge Compilation]]
  - wiki/concepts/rag.md → [[GraphRAG]]
  - wiki/concepts/rag.md → [[Project Synapse]]
  - wiki/entities/andrej-karpathy.md → [[LLM Wiki Pattern]]
  - wiki/entities/andrej-karpathy.md → [[RAG]]
  - wiki/entities/project-synapse.md → [[Neo4j]]
  - wiki/entities/project-synapse.md → [[Zettelkasten Engine]]
  - wiki/entities/project-synapse.md → [[LLM Wiki Pattern]]
  - wiki/sources/llm-wiki-pattern.md → [[Andrej Karpathy]]
  - wiki/sources/llm-wiki-pattern.md → [[RAG]]
...
**Broken links** (36):
  ...
  - wiki/log.md → [[RAG]]
  - wiki/log.md → [[Memex]]
  - wiki/log.md → [[LLM Wiki Pattern]]
  - wiki/log.md → [[Project Synapse]]
  - wiki/log.md → [[Persistent Knowledge Compilation]]
