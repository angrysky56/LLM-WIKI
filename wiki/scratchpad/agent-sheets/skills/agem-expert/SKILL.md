...
- [Orchestration Strategies](STRATEGIES.md) — Multi-perspective and verified reasoning flows.
- [Paraclete Proving Grounds](PROVING_GROUNDS.md) — Ethical scenario testing and generation.
