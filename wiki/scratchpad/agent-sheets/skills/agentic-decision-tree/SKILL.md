...
- [agentic-sequential](agentic-sequential.md) — Fixed workflow pattern
- [agentic-react](agentic-react.md) — Adaptive step-by-step
- [agentic-planner](wiki/concepts/agentic-planner.md) — Upfront planning
- [agentic-reflection](agentic-reflection.md) — Quality loops
- [agentic-multiagent](agentic-multiagent.md) — Specialist systems
