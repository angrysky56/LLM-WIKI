...
- [agentic-sequential](agentic-sequential.md) — For pipeline-style decomposition
- [agentic-react](agentic-react.md) — Each specialist may use ReAct
- [agentic-planner](wiki/concepts/agentic-planner.md) — Coordinator may use planning
- [agentic-reflection](agentic-reflection.md) — Specialists may use reflection for quality