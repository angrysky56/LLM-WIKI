...
- [agentic-react](agentic-react.md) — Foundation for within-stage execution
- [agentic-sequential](agentic-sequential.md) — When stages become deterministic
- [agentic-multiagent](agentic-multiagent.md) — When stages need different specialists