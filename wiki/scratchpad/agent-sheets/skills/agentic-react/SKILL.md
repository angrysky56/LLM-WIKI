...
- [agentic-planner](wiki/concepts/agentic-planner.md) — Add planning layer when structure is articulable
- [agentic-reflection](agentic-reflection.md) — Add quality checks when output matters
- [agentic-multiagent](agentic-multiagent.md) — Add specialists when needed