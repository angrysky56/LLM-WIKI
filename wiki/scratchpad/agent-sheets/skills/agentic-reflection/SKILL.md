...
- [agentic-react](agentic-react.md) — Often the generator's base pattern
- [agentic-planner](wiki/concepts/agentic-planner.md) — Checkpoint reflection between stages
- [agentic-multiagent](agentic-multiagent.md) — Specialist critics for domain quality