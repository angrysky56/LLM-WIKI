...
- [agentic-react](agentic-react.md) — Most common reasoning pattern using tools
- [agentic-planner](wiki/concepts/agentic-planner.md) — Tools for each planned stage
- [agentic-sequential](agentic-sequential.md) — Deterministic code vs. tools
