...
> **Key Action**: Follow the [Scaffolding Template](TEMPLATE.md) to initialize a new skill directory.
...
| **Validate** | Run [Compliance Checklist](CHECKLIST.md) | No second-person, no fluff           |
...
- [Template Scaffolding](TEMPLATE.md) — Pre-configured YAML and Markdown structure.
- [Validation Checklist](CHECKLIST.md) — Self-audit guide before deployment.
