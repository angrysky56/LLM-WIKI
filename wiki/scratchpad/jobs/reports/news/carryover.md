---
summary: "Three new stories: EU-US trade deal ratified with 2029 expiry, Trump walks back AI model vetting, Google DeepMind Gemini for Science launches"
...
- **EU-US Trade Deal**: Council and Parliament struck agreement on tariff elements (May 20). **Now formally ratified with 2029 expiry on safeguards** — most significant development this cycle.
...
- **EU-US Trade Deal Ratified** (May 20 new this cycle): Council and Parliament formally ratified deal with 2029 expiry on tariff safeguards. Legally binding bilateral architecture replacing political agreement. Supreme Court ruling provided legal basis — EU knew US tariff weapon was no longer legally available.
- **Trump AI Model Vetting Abandoned** (May 22 new this cycle): Second reversal in one week on federal AI governance. Pre-release vetting for Google/Microsoft/xAI models canceled before signing. Federal AI regulation definitively off table.
- **Gemini for Science** (May 26 new this cycle): Google DeepMind autonomous research platform that designs, executes, and interprets experiments. Co-Scientist multi-agent architecture. Most concrete step yet toward AI-native scientific discovery.
...
- **EU-US 2029 expiry mechanism**: whether other bilateral deals (India, ASEAN) use this format as template given Supreme Court limitations on US unilateral tariff authority

## Heading

**Next cycle (2026-05-28):**
1. Ebola — case count update, any new ETC attacks (pattern suggests May 29/30 attack window)
2. SpaceX IPO — pre-IPO developments, BlackRock $10B confirmation
3. China rare earth — any new export restriction announcements, allied responses
4. Gemini for Science outputs — whether early research results demonstrate accelerated discovery capability
5. California AI order — implementation action timeline

## New This Cycle

- **EU-US Trade Deal Ratified with 2029 Expiry** (May 20/27 confirmed): Legally binding bilateral framework. 2029 sunset on tariff safeguards. Most significant bilateral trade development since post-war era. Converts political agreement to binding architecture.
- **Trump AI Model Vetting Abandoned Before Signing** (May 22): Second reversal in one week, definitively closing federal AI regulatory path.
- **Gemini for Science Launched** (May 26): Google DeepMind autonomous research platform. AI-native experiment design, execution, interpretation. Co-Scientist multi-agent research partner.
- Stanford: Three Stanford medicine breakthroughs this week still dominant in AI-bioscience convergent narrative.

## Key Wiki Connections to Maintain

- `public-health-governance` — Ebola PHEIC response framework
- `who-emergency-declarations` — PHEIC history + Emergency Committee process
- `spacex-ipo-spcx-2026` — SpaceX IPO thread
- `AI-policy-federalism` — California/federal divergence, confirmed with new vetting abandonment
- `AI-scientific-discovery` — AI math proofs, quantum AI, Gemini for Science autonomous research
- `trump-tariffs` — tariff policy framework, Supreme Court ruling (May 2026), EU-US deal implications
- `Brazil-AI-governance` — Brazil election AI regulation test
- `malaysia-us-trade-deal` — Malaysia exit post-tariff-ruling
- `eu-us-trade-deal` — new page, bilateral architecture post-Liberation Day

## Kanban Status
- [x] Surfaced to hermes kanban: 2026-05-27 08:00
  - 9 open items → t_522317d1695c06b6, t_d275a369bd0a5c53, t_cd61d2c1271fde9e, t_5ecf600561f7ee38, t_1740456ab13dc256, t_4321d19f14b7242b, t_aacc9d95a694cdbe, t_c127c69b51095266, t_4173dfb19fe3aa6a

## Article Index (last 10 ingested — do NOT re-ingest)

| Date | Slug |
|------|------|
| 2026-05-27 | eu-us-trade-deal-2029-expiry-may-2026 |
| 2026-05-27 | trump-abandons-ai-model-vetting-may-2026 |
| 2026-05-27 | gemini-for-science-google-deepmind-may-2026 |
