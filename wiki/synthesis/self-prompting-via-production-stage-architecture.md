...
sources:
  - "[[chen-molecular-cot-2026|Chen et al. 2026 — Molecular Structure of Long CoT]]"
  - "[[shorthand-for-thought|Shorthand for Thought (supertokens)]]"
  - "[[bae-mor-2025|MoR dynamic recursion depth]]"
  - "[[entropic-machinery-cot-and-flagellum|Entropic Machinery synthesis]]"
  - "[[llm-biological-analogies|Biological Analogies in LLMs]]"
status: active
